...
lazy val root = (project in file("."))
    .settings(
        ...
        fork := true,
        javaOptions ++= Seq("-Djavax.net.ssl.trustStore=./target/etc/horizon/exchange/truststore/localhost.p12", "-Djavax.net.ssl.trustStorePassword=truststore-password"),  // "-Djavax.net.debug=all"
