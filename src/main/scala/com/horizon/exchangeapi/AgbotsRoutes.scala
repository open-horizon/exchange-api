        ...
        complete({
          ...
          db.run(AgbotsTQ.getNumOwned(owner).result.flatMap({ xs =>
            ...
            case Success(v) =>
              ...
              val agbotChange = ResourceChangeRow(0L, orgid, id, "agbot", "false", "agbot", ResourceChangeConfig.CREATEDMODIFIED, ApiTime.nowUTC)
          ...
          if (action == null) (HttpCode.BAD_INPUT, ApiResponse(ApiRespType.BAD_INPUT, ExchMsg.translate("no.valid.agbot.attribute.specified")))
            ...
            case Success(v) =>
              ...
              if (v.asInstanceOf[Int] > 0) { // there were no db errors, but determine if it actually found it or not
                ...
                val agbotChange = ResourceChangeRow(0L, orgid, id, "agbot", "false", "agbot", ResourceChangeConfig.MODIFIED, ApiTime.nowUTC)
                agbotChange.insert.asTry
              } else {
        ...
        db.run(AgbotsTQ.getAgbot(compositeId).delete.transactionally.asTry.flatMap({
          case Success(v) =>
            if (v > 0) { // there were no db errors, but determine if it actually found it or not
              ...
              val agbotChange = ResourceChangeRow(0L, orgid, id, "agbot", "false", "agbot", ResourceChangeConfig.DELETED, ApiTime.nowUTC)
              agbotChange.insert.asTry
            } else {
              DBIO.failed(new DBProcessingError(HttpCode.NOT_FOUND, ApiRespType.NOT_FOUND, ExchMsg.translate("agbot.not.found", compositeId))).asTry
            }
        ...
        complete({
          ...
          db.run(PatternsTQ.getPattern(OrgAndId(reqBody.patternOrgid,reqBody.pattern).toString).length.result.asTry.flatMap({
            ...
            case Success(v) =>
              ...
              val agbotChange = ResourceChangeRow(0L, orgid, id, "agbot", "false", "agbotpatterns", ResourceChangeConfig.CREATED, ApiTime.nowUTC)
              agbotChange.insert.asTry
            case Failure(t) => DBIO.failed(t).asTry
          })).map({
            case Success(v) =>
        ...
        db.run(AgbotPatternsTQ.getPatterns(compositeId).delete.asTry.flatMap({
          case Success(v) =>
            if (v > 0) { // there were no db errors, but determine if it actually found it or not
              ...
              val agbotChange = ResourceChangeRow(0L, orgid, id, "agbot", "false", "agbotpatterns", ResourceChangeConfig.DELETED, ApiTime.nowUTC)
              agbotChange.insert.asTry
            } else {
        ...
        complete({
          ...
          db.run(BusinessPoliciesTQ.getBusinessPolicy(OrgAndId(reqBody.businessPolOrgid,reqBody.businessPol).toString).length.result.asTry.flatMap({
            ...
            case Success(v) =>
              ...
              val agbotChange = ResourceChangeRow(0L, orgid, id, "agbot", "false", "agbotbusinesspols", ResourceChangeConfig.CREATED, ApiTime.nowUTC)
              agbotChange.insert.asTry
            case Failure(t) => DBIO.failed(t).asTry
          })).map({
            case Success(v) =>
        ...
        db.run(AgbotBusinessPolsTQ.getBusinessPols(compositeId).delete.asTry.flatMap({
          case Success(v) =>
            if (v > 0) { // there were no db errors, but determine if it actually found it or not
              ...
              val agbotChange = ResourceChangeRow(0L, orgid, id, "agbot", "false", "agbotbusinesspols", ResourceChangeConfig.DELETED, ApiTime.nowUTC)
              agbotChange.insert.asTry
            } else {
        ...
        complete({
          db.run(AgbotAgreementsTQ.getNumOwned(compositeId).result.flatMap({ xs =>
            ...
            case Success(v) =>
              ...
              val agbotChange = ResourceChangeRow(0L, orgid, id, "agbot", "false", "agbotagreements", ResourceChangeConfig.CREATEDMODIFIED, ApiTime.nowUTC)
              agbotChange.insert.asTry
            case Failure(t) => DBIO.failed(t).asTry
          })).map({
            case Success(v) =>
        ...
        db.run(AgbotAgreementsTQ.getAgreements(compositeId).delete.asTry.flatMap({
          case Success(v) =>
            if (v > 0) { // there were no db errors, but determine if it actually found it or not
              ...
              val agbotChange = ResourceChangeRow(0L, orgid, id, "agbot", "false", "agbotagreements", ResourceChangeConfig.DELETED, ApiTime.nowUTC)
              agbotChange.insert.asTry
            } else {
      ...
      complete({
        ...
        db.run(AgbotMsgsTQ.getMsgsExpired.delete.flatMap({ xs =>
          ...
          case Success(v) =>
            ...
            msgNum = v.toString
            val agbotChange = ResourceChangeRow(0L, orgid, id, "agbot", "false", "agbotmsgs", ResourceChangeConfig.CREATED, ApiTime.nowUTC)
            agbotChange.insert.asTry
          case Failure(t) => DBIO.failed(t).asTry
        })).map({
          case Success(v) =>
        ...
        try {
          ...
          db.run(AgbotMsgsTQ.getMsg(compositeId,msgId).delete.asTry.flatMap({
            case Success(v) =>
              ...
              if (v > 0) { // there were no db errors, but determine if it actually found it or not
                val agbotChange = ResourceChangeRow(0L, orgid, id, "agbot", "false", "agbotmsgs", ResourceChangeConfig.DELETED, ApiTime.nowUTC)
                agbotChange.insert.asTry
              } else {
