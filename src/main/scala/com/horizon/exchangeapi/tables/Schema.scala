  ...
  def getUpgradeSchemaStep(fromSchemaVersion: Int, step: Int)(implicit logger: LoggingAdapter): DBIO[_] = {
    step match {
      case 0 => // v1.35.0 - no changes needed to get to time zero
        DBIO.seq()
      case 1 => // v1.37.0
        DBIO.seq(NodeStatusTQ.schema.createIfNotExists)
      case 2 => // v1.38.0
        DBIO.seq(sqlu"ALTER TABLE public.agbots DROP COLUMN IF EXISTS patterns",
                 AgbotPatternsTQ.schema.createIfNotExists)
      case 3 => // v1.45.0
        DBIO.seq(ServicesTQ.schema.createIfNotExists)
      case 4 =>
        DBIO.seq(/* WorkloadKeysTQ.schema.create, MicroserviceKeysTQ.schema.create, ServiceKeysTQ.schema.create, */
                 PatternKeysTQ.schema.createIfNotExists)
      case 5 => // v1.47.0
      ...
      case 9 => // v1.52.0
        DBIO.seq(ServiceDockAuthsTQ.schema.createIfNotExists)
      case 10 => // v1.56.0
      ...
      case 18 => // v1.77.0
        DBIO.seq(NodePolicyTQ.schema.createIfNotExists)
      case 19 => // v1.77.0
        DBIO.seq(ServicePolicyTQ.schema.createIfNotExists)
      case 20 => // v1.78.0
        DBIO.seq(BusinessPoliciesTQ.schema.createIfNotExists)
      case 21 => // v1.82.0
      ...
      case 22 => // v1.82.0
        DBIO.seq(AgbotBusinessPolsTQ.schema.createIfNotExists)
      case 23 => // v1.83.0
      ...
      case 37 =>
        DBIO.seq(SearchOffsetPolicyTQ.schema.createIfNotExists)
      case 38 => // v2.42.0
      ...
      case 42 => // v2.89.0
        DBIO.seq(ManagementPoliciesTQ.schema.createIfNotExists)
      case 43 => // v2.57.0
      ...
      case 46 => // v2.96.0
        DBIO.seq(AgentCertificateVersionsTQ.schema.createIfNotExists,
                 ...
                 AgentSoftwareVersionsTQ.schema.createIfNotExists,
                 AgentVersionsChangedTQ.schema.createIfNotExists)
      case 47 => // v2.100.0
      ...
      case 49 =>
        DBIO.seq(NodeGroupTQ.schema.createIfNotExists,
                 NodeGroupAssignmentTQ.schema.createIfNotExists)
      case 50 => // v2.108.0
