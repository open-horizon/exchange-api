...
EXCHANGE_NODEAUTH="${EXCHANGE_NODEAUTH:-n1:abc123ABC123456}"
EXCHANGE_AGBOTAUTH="${EXCHANGE_AGBOTAUTH:-a1:abc123ABC123456}"
...
checkrc "$rc" 200 404
if [[ $rc != 200 ]]; then
    curlcreate "PUT" $userauth "orgs/$orgid/nodes/$nodeid" '{"token": "'$nodetoken'", "name": "rpi1", "nodeType": "device", "pattern": "'$orgid'/'$patid'",
  "registeredServices": [
    {
      "url": "'$orgid'/'$svcurl'",
      "configState": "active",
