...
test("PUT /orgs/" + orgid + "/users/" + user + " - update normal with creds") {
  ...
  test("POST /orgs/"+orgid+"/patterns/"+pattern+" - add "+pattern+" as not public in 1st org") {
    val input = PostPutPatternRequest("Pattern", None, None, List(PServices(svcurl, orgid, svcarch, None, List(PServiceVersions(svcversion,None,None,None,None)), None, None)), None, None, None)
  ...
  test("POST /orgs/"+orgid+"/business/policies/"+"mybuspol"+" - add "+"mybuspol"+" as user") {
    val input = PostPutBusinessPolicyRequest("mybuspol", None, BService(svcurl, orgid, svcarch, List(BServiceVersions(svcversion, None, None)), None ), None, None, None, None)
