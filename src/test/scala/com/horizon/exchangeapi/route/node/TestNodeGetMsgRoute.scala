...
import com.horizon.exchangeapi.{ApiTime, ApiUtils, GetNodeMsgsResponse, HttpCode, Role, TestDBConnection, tables}
import com.horizon.exchangeapi.tables.{AgbotRow, AgbotsTQ, NodeMsgRow, NodeMsgsTQ, NodeRow, NodesTQ, OrgRow, OrgsTQ, ResourceChangesTQ, UserRow, UsersTQ}
...
class TestNodeGetMsgRoute extends AnyFunSuite with BeforeAndAfterAll {
  ...
  private val TESTNODEMESSAGES: Seq[NodeMsgRow] =
    Seq(tables.NodeMsgRow(agbotId     = "TestNodeGetMsgRoute/a1",
                          agbotPubKey = "",
