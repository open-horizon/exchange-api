...
class BlockchainsSuite extends FunSuite {
  ...
  test("Add users, device, bctype for future tests") {
    ...
    val devInput = PutDevicesRequest(deviceToken, "bc dev test", List(Microservice("foo",1,"{}",List(
  ...
  test("GET /bctypes - get initial number of bctypes in the db") {
  ...
  test("PUT /bctypes/"+bctype2+" - invalid bctype body") {
    val badJsonInput = """{
      "description": "foo"
    }"""
  ...
  test("GET /bctypes - filter owner and description") {
  ...
  test("GET /bctypes/"+bctype+" - as user") {
  ...
  test("GET /bctypes/"+bctype+" - as device") {       // will do agbot soon
  ...
  test("PATCH /bctypes/"+bctype+" - as user") {
  ...
  test("PATCH /bctypes/"+bctype+" - as user2 - should fail") {
  ...
  test("GET /bctypes/"+bctype+" - as agbot, check patch by getting that 1 attr") {
  ...
  test("GET /bctypes/"+bctype+"notthere - as user - should fail") {
  ...
  test("GET /bctypes/"+bctype+"/blockchains - none there yet") {
  ...
  test("GET /bctypes/"+bctype+"/blockchains/"+bcname+" - not there yet") {
  ...
  test("GET /bctypes/"+bctype+"/blockchains - filter owner and description") {
  ...
  test("GET /bctypes/"+bctype+"/blockchains - as device") {
  ...
  // GET /bctypes/{bctype}/blockchains - as agbot is done below

  test("GET /bctypes/"+bctype+"/blockchains/"+bcname+" - as user") {
    val response: HttpResponse[String] = Http(URL+"/bctypes/"+bctype+"/blockchains/"+bcname).headers(ACCEPT).headers(USERAUTH).asString
    info("code: "+response.code)
    assert(response.code === HttpCode.OK)
    val getBcResp = parse(response.body).extract[GetBlockchainsResponse]
  ...
  test("GET /bctypes/"+bctype+"/blockchains/"+bcname+" - as device") {
  ...
  test("PATCH /bctypes/"+bctype+"/blockchains/"+bcname+" - as user") {
  ...
  test("PATCH /bctypes/"+bctype+"/blockchains/"+bcname+" - as user2 - should fail") {
  ...
  test("GET /bctypes/"+bctype+"/blockchains/"+bcname+" - as agbot, check patch by getting that 1 attr") {
  ...
  test("GET /bctypes/"+bctype+"/blockchains/"+bcname+"notthere - as user - should fail") {
  ...
  test("GET /bctypes/"+bctype+"/blockchains/"+bcname+" - as agbot - verify still there") {
  ...
  test("GET /bctypes/"+bctype+"/blockchains/"+bcname+" - as device - verify gone") {
    val response: HttpResponse[String] = Http(URL+"/bctypes/"+bctype+"/blockchains/"+bcname).headers(ACCEPT).headers(DEVICEAUTH).asString
    info("code: "+response.code)
    assert(response.code === HttpCode.NOT_FOUND)
    val getBcResp = parse(response.body).extract[GetBlockchainsResponse]
  ...
  test("GET /bctypes/"+bctype+"/blockchains/"+bcname2+" - as user - verify gone") {
  ...
  test("GET /bctypes/"+bctype+" - as user - verify gone") {
    val response: HttpResponse[String] = Http(URL+"/bctypes/"+bctype).headers(ACCEPT).headers(USERAUTH).asString
    info("code: "+response.code)
    // info("code: "+response.code+", response.body: "+response.body)
    assert(response.code === HttpCode.NOT_FOUND)
  ...
  test("GET /bctypes/"+bctype2+"/blockchains/"+bcname2+" - as user - verify gone") {
  ...
  test("GET /bctypes/"+bctype2+" - as user - verify gone") {
