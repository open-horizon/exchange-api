...
//  val service3 = svcBase3 + "_" + svcVersion3 + "_" + svcArch3
  ...
  //val dockAuthId = 1  // <- this is auto-generated by the db so also varies
  val dockAuthRegistry = "registry.ng.bluemix.net"
  val dockAuthToken = "tok1"
  //val dockAuthId2 = 2  // <- this is auto-generated by the db so also varies
  ...
  */
  ...
  test("PUT /orgs/"+orgid+"/services/"+service+"/dockauths/1 - try to update before any exist - should fail") {
    val input = PostPutServiceDockAuthRequest(dockAuthRegistry+"-updated", dockAuthToken+"-updated")
  ...
  test("POST /orgs/"+orgid+"/services/"+service+"/dockauths - add a dockauth as user") {
    val input = PostPutServiceDockAuthRequest(dockAuthRegistry, dockAuthToken)
